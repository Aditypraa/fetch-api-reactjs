...
function FormLogin() {
    ...
    return (
        <form onSubmit={handleLogin}>
            <InputForm type="text" placeholder="Enter your username" name="username" label="Username"
            ...
            {loginFailed && <p className="text-red-500 text-sm text-center mt-5">{loginFailed}</p>}
        </form>
    )
}
